          ...
          <div className="bg-white artsummry ">
            <div className="bg-secondary">
              ...
              <p className="text-sm font-medium lg:text-base lg:ps-5 text-typography">
                You can upload your files below, or skip this step and upload
                your files later at a time that suits you.
              </p>
            </div>
          </div>
            ...
            <div className="w-full px-5 mt-5 lg:w-2/3">
              <div className="flex justify-center bg-white">
                <div className="py-4 md:py-6 lg:py-10">
                  <div className="flex gap-2 md:gap-4 lg:gap-6">
                    <button className="flex px-2 py-2 text-base font-medium rounded-md text-secondgraphy md:text-lg lg:text-xl md:font-semibold lg:font-bold md:px-8 lg:px-8 xl:px-16 bg-primary hover:bg-primary ">
              ...
              <div className="flex p-2 py-5 mt-5 mb-5 border rounded-md border-typography md:p-5 md:mb-10 ">
                ...
                <p className=" text-[10px] font-normal text-typography md:text-sm">
                  ...
                  Orders in the MyAccount area. After these 15 minutes, no
                  further changes can be made and all artwork will be processed
                  for printing
                </p>
              </div>
